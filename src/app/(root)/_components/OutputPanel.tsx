...
function OutputPanel() {
  ...
  return (
    <div className="relative bg-[#181825] rounded-xl p-4 ring-1 ring-gray-800/50 w-full h-full">
      ...
      <div className="relative w-full h-full">
        <div
          className="relative w-full h-full bg-[#1e1e2e]/50 backdrop-blur-sm border border-[#313244] 
