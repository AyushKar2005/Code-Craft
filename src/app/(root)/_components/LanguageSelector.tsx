...
function LanguageSelector({ hasAccess }: { hasAccess: boolean }) {
  ...
  const handleLanguageSelect = (langId: string) => {
    // 🔧 Removed restriction: now all users can select any language
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      rounded-lg transition-all 
       ...
       ${
         // 🔧 Removed opacity/cursor restriction
         "" 
       }`}
      >
        {/* Decoration */}
          ...
          >
            ...
            <div className="max-h-[280px] overflow-y-auto overflow-x-hidden">
              {Object.values(LANGUAGE_CONFIG).map((lang, index) => {
                // 🔧 Force all languages to be accessible
                ...
                return (
                  ...
                  >
                    ...
                    `}
                      ...
                      disabled={false} // 🔧 Disabled set to false for all languages
                    >
                      {/* decorator */}
                      <div
                      ...
                      {/* 🔧 Removed lock icon and kept only selected indicator */}
                      {language === lang.id && (
